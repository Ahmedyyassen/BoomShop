...
const SearchBox = () => {
  ...
  return (
    ...
    <input value={value} onChange={(e)=>setValue(e.target.value)}  type="text" placeholder="Search For Products" className="outline-0 h-10 w-full 2xl:h-12 md:w-[400px] 2xl:w-[500px] py-1 px-4 rounded-l-4xl " />
    <button type="submit" className={`h-10 2xl:h-12 w-[80px] md:w-[100px] 2xl:w-[100px] rounded-r-4xl bg-main-main text-xl flex justify-center items-center cursor-pointer`}><FaSearch className="fill-white" /></button>
